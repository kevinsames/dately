...
const translations = {
  en: {
    ...
    accommodationOption2Detail: "10 min from venue · Ahrensfelder Weg 48-50",
    accommodationOption2Url: "https://www.ringhotel-ahrensburg.de/gastezimmer",
    contactHeading: "Contact",
    contactBody: "For any questions, feel free to reach out to Sima:",
    ...
    foodHeading: "Dietary Requirements",
    foodBody:
      "Vegetarian, vegan, or any allergies / intolerances? Please let Sima know: 0176 60954622",
    musicHeading: "Song Requests",
    musicBody:
      "What gets your hips moving? Share your favourite songs with Sima and make sure the dance floor is packed!",
  ...
  de: {
    ...
    accommodationOption1Url: "https://www.hotel-am-schloss.de",
    accommodationOption2Name: "Ringhotel Ahrensburg",
    accommodationOption2Detail: "10 Min. entfernt · Ahrensfelder Weg 48-50",
    accommodationOption2Url: "https://www.ringhotel-ahrensburg.de/gastezimmer",
    contactHeading: "Kontakt",
    contactBody: "Bei weiteren Fragen wendet euch gerne an Sima:",
    ...
    foodHeading: "Essensvorlieben",
    foodBody:
      "Vegetarisch, vegan oder Allergien/Unverträglichkeiten? Bitte gebt Sima Bescheid: 0176 60954622",
    musicHeading: "Musikwünsche",
    musicBody:
      "Was bringt eure Hüften zum Schwingen? Teilt eure Lieblingssongs mit Sima und sorgt dafür, dass die Tanzfläche garantiert voll wird!",
    fingerfoodHeading: "Fingerfood-Buffet",
    fingerfoodBody:
  ...
  fa: {
    ...
    accommodationOption1Url: "https://www.hotel-am-schloss.de",
    accommodationOption2Name: "Ringhotel Ahrensburg",
    accommodationOption2Detail: "۱۰ دقیقه تا محل · Ahrensfelder Weg 48-50",
    accommodationOption2Url: "https://www.ringhotel-ahrensburg.de/gastezimmer",
    contactHeading: "تماس",
    contactBody: "برای سؤالات بیشتر با سیما تماس بگیرید:",
    ...
    foodHeading: "ترجیحات غذایی",
    foodBody:
      "گیاهخوار، وگان یا آلرژی/عدم تحمل دارید؟ لطفاً به سیما اطلاع دهید: 0176 60954622",
    musicHeading: "آهنگ‌های مورد علاقه",
    musicBody:
      "چه آهنگ‌هایی شما را به رقص وا می‌دارد؟ آهنگ‌های مورد علاقه‌تان را با سیما به اشتراک بگذارید!",
